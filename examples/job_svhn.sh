...
#SBATCH --output svhn.%N.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error svhn.%N.%j.err  # filename for STDERR
...
python3 mnist.py --dataset svhn --datapath /home/aprabh2s/NAS/enas/data/
echo "complete"
