...
#SBATCH --output deva.%N.%j.out # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error deva.%N.%j.err  # filename for STDERR
...
python3 mnist.py --dataset devanagari --datapath /home/aprabh2s/NAS/enas/data/DevanagariHandwrittenCharacterDataset/
echo "complete"
